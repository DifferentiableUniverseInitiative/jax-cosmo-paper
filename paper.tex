...
Monte Carlo Markov Chain Bayesian inference is a widely used technique in Cosmology since the work of \citep{2001ApJ...563L..95K,2003MNRAS.341.1084R} and has been the keystone for past and current analysis\footnote{see for instance \url{https://ui.adsabs.harvard.edu/abs/2021JCAP...05..057T/citations}.} thanks to software as  \texttt{CosmoMC}\footnote{\url{https://cosmologist.info/cosmomc/readme.html}} \citep{2002PhRvD..66j3511L} as well as   \texttt{Cobaya}\footnote{\url{https://cobaya.readthedocs.io}} \citep{2019ascl.soft10019T,2021JCAP...05..057T}. 
...
Monte Carlo sampler with JAX-Cosmo (blue), compared to the \texttt{Cobaya} Metropolis-Hastings sampler (orange).}
\end{figure}
